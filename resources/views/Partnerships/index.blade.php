                    ...
                    <tbody>
                        @foreach ($partnerships as $post)
                            <tr>
                                ...
                                <td><img src="{{ $post->image }}" alt="{{ $post->image }}" class="h-36 md:h-30 my-4"></td>
                                <td>
                                    <div class="">
                                        ...
                                        <form action="{{ url('/partnerships/' . $post->id . '/delete') }}" method="POST" class="inline" enctype="multipart/form-data">
                                            @method('delete')
                                            @csrf
                                            <button onclick="return confirm('Are you sure you want to delete partnership?')"
                                                type="submit"
