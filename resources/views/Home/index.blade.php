...
<body class="composer">
    ...
    {{-- Section 4 --}}
    <div id="section-4" class="flex justify-center w-full my-4">
        <div id="instagram-embeds" class="flex justify-center flex-wrap align-middle w-fit max-w-[90%] my-4 py-2 bg-slate-200 rounded-lg">
