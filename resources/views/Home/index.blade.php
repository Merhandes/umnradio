...
<body class="composer">
    ...
    {{-- Section 4 --}}
    <div id="section-4" class="flex justify-center w-full my-4 mx-4">
        <div id="instagram-embeds" class="flex justify-center flex-wrap align-middle w-fit my-4 px-2 py-2 bg-slate-200 rounded-lg">
        ...
        <div class="swiper">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <h3 class="swipe_here md:hidden w-full absolute bottom-0.5 text-neutral-400 text-center">Swipe Here</h3>
                </div>
                <div class="swiper-slide">
                    <iframe style="border-radius:15px"
