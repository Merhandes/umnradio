...
{{-- <body class="h-screen bg-white"> --}}
    {{-- POST FORM --}}
    <div class="pt-20 md:pt-36 px-6 md:mx-12 font-poppins text-black pb-24 flex justify-center flex-wrap gap-5 h-full overflow-scroll">
        <div class="w-full">
                    ...
                    <tbody>
                        @foreach ($payments as $payment)
                            <tr>
                                ...
                                <td><a target="_" href="{{ asset('storage/' . $payment->image) }}"><img
