...
@section('container')
    <div class="pt-10 mx-6 md:mx-20 font-poppins text-black pb-24">
        ...
        <a href="/dashboard/programs/new" class="container w-full mx-auto px-2">
            <button
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        ...
                                        <a href="/dashboard/programs/{{ $programdetail->slug }}/edit">
                                            <button
                                        ...
                                        <form action="/dashboard/programs/{{ $programdetail->slug }}/delete" method="post"
                                            class="inline">
                                            @method('delete')
                                            @csrf
