<div>
    ...
    <div x-data="{ isOpen: false }" class="sticky w-full flex justify-between p-3 z-40 bg-[#021f3a] lg:p-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="pr-4 hidden space-x-6 lg:inline-block w-fit">
                ...
                @endbendahara
                @news()
                <a href="/dashboard/posts" class="font-poppins text-base text-white no-underline">News</a>
                @endnews()
                @admin()
            ...
            <div class="relative hover:cursor-pointer" id="parent">
                ...
                <form action="/logout" method="POST">
                    ...
                    <div id="logoutDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg hidden">
                        <button type="submit" class="block w-full text-left px-4 py-2 text-[#021f3a] hover:bg-gray-200 hover:rounded-lg">
                            Logout
                        </button>
                    </div>
                </form>
            ...
            <div class="mobile-navbar">
                <div class="fixed left-0 w-full h-fit p-5 bg-white rounded-lg shadow-xl top-16" x-show="isOpen"
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        @endbendahara
                        @news()
                        <a href="/dashboard/posts" class="font-poppins text-sm text-black">News</a>
                        @endnews()
                        @admin()
