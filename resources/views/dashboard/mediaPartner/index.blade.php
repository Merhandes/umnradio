...
@section('container')
    <div class="pt-10 mx-6 md:mx-20 font-poppins text-black pb-24">
        <h1 class="pt-12 md:pt-24 text-center font-bold mb-6">Media Partners</h1>
        <a href="/dashboard/mediapartners/create" class="container w-full mx-auto px-2">
            <button
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="">
                                        ...
                                        <form action="{{ url('/dashboard/mediapartners/' . $post->id . '/delete') }}"
