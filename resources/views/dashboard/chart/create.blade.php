...
@section('container')
    ...
    <div class="pt-10 mx-6 md:mx-48 font-poppins text-black pb-24">
        <h1 class="pt-12 md:pt-24 text-center font-bold mb-6">New Chart</h1>
        ...
        <form id="chartForm" class="w-[90%]" action="/dashboard/charts/store" enctype="multipart/form-data" method="post">
            @csrf
            ...
            <div class="my-2">
                ...
                <input data-index='1'
                    ...
                    value="{{ old('chart_name') }}" oninput="previewName(this.value)">
                @error('chart_name')
                ...
                <div class="song-container flex flex-col gap-2 justify-center p-4 w-full">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="text-lg md:text-2xl text-black font-poppins font-bold">SONG NAME</p>
                            <p class="text-sm md:text-md text-gray-800 font-poppins">artist name, artist name, artist
