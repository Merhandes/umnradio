<div>
    ...
    <div x-data="{ isOpen: false }"
        class="fixed w-full flex justify-between z-40 drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)] px-3 pt-2 pb-3 lg:px-4 lg:pt-2">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="pr-4 hidden space-x-6 w-fit lg:flex flex-row">
                ...
                {{--<a href="/ultimacrews" class="relative flex justify-center items-center align-middle w-fit hover:scale-110 hover:rotate-3">
                    <img class="absolute -z-10 h-full w-full" src="{{ asset('assets/tapes/65.webp') }}" alt="">
                    <p class="font-nexarust font-bold text-black no-underline z-20 text-xl mx-4 my-3">Crews</p>
                </a>--}}
            ...
            <div class="mobile-navbar">
                <div class="fixed left-0 w-full h-fit p-5 bg-white rounded-lg shadow-xl top-16" x-show="isOpen"
                    ...
                    <div class="flex flex-col space-y-6">
                        ...
                        {{--<a href="/ultimacrews" class="font-poppins text-sm text-black">Crews</a>--}}
