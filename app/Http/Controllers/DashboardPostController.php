...
class DashboardPostController extends Controller
{
    ...
    public function index()
    {
        //
        $posts = Post::all();
        return view('dashboard.article.index', ['posts' => $posts]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/posts')->with('success', "Article published");
    }
    ...
    public function show(Post $post)
    {
        ...
        return view('dashboard.article.show', ['post' => $post, 'articles' => $articles]);
    }
    ...
    public function edit(Post $post)
    {
        ...
        return view('dashboard.article.edit', ['post' => $post]);
    }
    ...
    public function update(Request $request, Post $post)
    {
        ...
        return redirect('/dashboard/posts')->with('success', "Article updated.");
    }
    ...
    public function showArticle(Post $post)
    {
        ...
        $articles = Post::latest()->where('id', '!=', $post->id)->take(5)->get();
        return view('article.detail', ['post' => $post, 'articles' => $articles, 'suggestions' => $suggestions]);
    }
}
